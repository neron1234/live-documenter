...
namespace TheBoxSoftware.Documentation.FileParsers
{
    ...
    internal abstract class ProjectFileReader : FileReader
    {
        ...
        /// <exception cref="InvalidOperationException">Thrown when no output path is defined in the project.</exception>
        public override List<DocumentedAssembly> Read()
        {
            ...
            {
                throw new InvalidOperationException(string.Format("No output path defined for the project '{0}'.", this.FileName));
            }
        }
